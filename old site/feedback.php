...
while($row = mysqli_fetch_array($result))
{
  ...
  $imgCountryName=str_replace(' ', '-', $row['COUNTRY']);
  echo "<tr><td><span class='commentor'>".$row['NAME']."</span><br>"."<img alt='".$row['COUNTRY']."' title='".$row['COUNTRY']."' src='/img/flags/".$imgCountryName.".png' /><br>".$row['Time']."</td>"."<td>".$row['FEEDBACK']."</td></tr>";
